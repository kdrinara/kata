...
class Main {
    ...
    static String calc(String input) {
        ...
        if ((input.contains("I") || input.contains("V") || input.contains("X")) &&
            (operand1 < 1 || operand1 > 10 || operand2 < 1 || operand2 > 10)) {
            throw new IllegalArgumentException("Числа должны быть от I до X.");
        }
    ...
    static int parseOperand(String operandStr) {
        try {
            if (operandStr.equals("I")) return 1;
            if (operandStr.equals("II")) return 2;
            if (operandStr.equals("III")) return 3;
            if (operandStr.equals("IV")) return 4;
            if (operandStr.equals("V")) return 5;
            if (operandStr.equals("VI")) return 6;
            if (operandStr.equals("VII")) return 7;
            if (operandStr.equals("VIII")) return 8;
            if (operandStr.equals("IX")) return 9;
            if (operandStr.equals("X")) return 10;
